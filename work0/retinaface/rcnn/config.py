...
config.TRAIN.RPN_BATCH_SIZE = 8 #256
...
network.resnet.BATCH_IMAGES = 2#8
network.resnet.HEAD_FILTER_NUM = 8#256
network.resnet.CONTEXT_FILTER_RATIO = 1
network.resnet.USE_DCN = 2
network.resnet.RPN_BATCH_SIZE = 8#256 
